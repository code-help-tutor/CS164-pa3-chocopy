 ...
 * this class.
 */
public sealed abstract class Expr extends Node permits
    BinaryExpr, CallExpr, Identifier, IfExpr, IndexExpr, ListExpr, Literal,
    MemberExpr, MethodCallExpr, UnaryExpr, StudentExpr
{
