...
import chocopy.common.astnodes.StudentLiteral;
...
public class Constants {
    ...
    public final Label falseConstant = generateConstantLabel();

    /** The constant representing the boolean `True`.  This immediately
     *  follows falseConstant in static memory. */
    public final Label trueConstant = generateConstantLabel();

    /** A cache for integer-valued constants. */
    public final Map<Integer, Label> intConstants = new HashMap<>();

    /** A cache for string-valued constants. */
    public final Map<String, Label> strConstants = new HashMap<>();
    ...
    public Label fromLiteral(Literal literal) {
        return switch (literal) {
            case IntegerLiteral intLit -> getIntConstant(intLit.value);
            case StringLiteral strLit -> getStrConstant(strLit.value);
            case BooleanLiteral boolLit -> getBoolConstant(boolLit.value);
            case NoneLiteral _noneLit -> null;
            case StudentLiteral studentLit -> {
                String className = studentLit.getClass().getCanonicalName();
